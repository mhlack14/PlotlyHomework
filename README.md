...
* Use `sample_values` as the values for the bar chart. (Y:Y_values)

* Use `otu_ids` as the labels for the bar chart. (x:Sample_values)

* Use `otu_labels` as the hovertext for the chart. (text:otu_labels)
